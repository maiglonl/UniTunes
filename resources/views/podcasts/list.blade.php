					...
					<section class="vbox animated fadeInUp">
						<section class="scrollable hover">
							<div class="list-group no-radius no-border no-bg m-t-n-xxs m-b-none auto">
								<a href="{{ route('podcasts.list', 0) }}" class="list-group-item">
									Todas
								</a>
								@foreach($categories as $categ)
									@if($categ->id == $cotegorie)
									<a href="{{ route('podcasts.list', $categ->id) }}" class="list-group-item active">
									@else
									<a href="{{ route('podcasts.list', $categ->id) }}" class="list-group-item">
									@endif
										{{ $categ->name }}
									</a>
								@endforeach
									...
									<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
										<div class="item">
											<div class="pos-rlt">
													...
													<div class="bottom padder m-b-sm">
														@if($podcast->idFavorite != null)
															<a href="#" data-toggle="class" class="pull-right">
																<i class="fa fa-heart text-danger text" onclick="unsetFavorite({{ $podcast->idFavorite }})"></i>
														...
														@else
															<a href="#" data-toggle="class" class="pull-right">
																...
																<i class="fa fa-heart text-danger text-active" onclick="unsetFavorite({{ $podcast->idFavorite }})"></i>
															</a>
														@endif
												...
												<a href="#"><img style="height: 170px;" src="{{ URL::asset("storage/images/$podcast->id.$podcast->imageExt") }}" alt="{{ $podcast->name }}" class="r r-2x img-full"></a>
											</div>
											<div class="padder-v">
