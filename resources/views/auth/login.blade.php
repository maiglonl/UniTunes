	...
	<section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
		<div class="container aside-xl">
			...
			<section class="m-b-lg">
				<form class="form-horizontal" role="form" method="POST" method="POST" action="{{ url('/login') }}">
					{{ csrf_field() }}
					...
					<div class="text-center m-t m-b"><a href="{{ url('/password/reset') }}"><small>Esqueceu a senha?</small></a></div>
					<div class="line line-dashed"></div>
					<p class="text-muted text-center"><small>Não possui uma conta?</small></p>
					<a href="{{ url('/register') }}" class="btn btn-lg btn-info btn-block rounded">Criar conta</a>
				</form>
			</section>
		</div>
	</section>
